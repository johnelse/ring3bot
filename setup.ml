...
(* OASIS_START *)
(* DO NOT EDIT (digest: d82ff553555b6fd6968fd6ed78aa4833) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Config_j"; "Config_t"; "Config"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ring3bot-lib";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ring3bot.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "e\229\161\193\172\255\b>2\201\252\005R\170\179\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
